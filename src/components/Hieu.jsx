                    ...
                    <div className=' w-full grid grid-cols-2 max-w-[1024px] px-4 mx-auto md:space-x-5'>
                        ...
                        className='text-right  font-Quicksand px-3'>
                            <p className=' text-[16px] md:text-xl text-[#8892b0]'>
                                Hi. I'm Le Trung Hieu. I'm a leader of group 14.
                            </p>
                        </animated.div>
                        <animated.div 
                        style={{
                        ...
                        <p className=' text-[16px] md:text-xl text-[#8892b0]'>
                           My favorite food is pizza.In my free time, i like to watch movie and play games on my phone.I like to hangout with friend and have some coffee. 
                        </p>
                        </animated.div>
