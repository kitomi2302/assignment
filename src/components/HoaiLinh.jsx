                    ...
                    <div className=' w-full grid grid-cols-2 max-w-[1024px] px-4 mx-auto md:space-x-5'>
                        ...
                        className='text-right  font-Quicksand px-3'>
                            <p className=' text-[16px] md:text-xl text-[#8892b0]'>
                                Hi. I'm Nguyen Hoai Linh. I'm a member of group 14.
                            </p>
                        </animated.div>
                        <animated.div 
                        style={{
                        ...
                        <p className=' text-[16px] md:text-xl text-[#8892b0]'>
                           I'm a beautiful girl, I like to hangout with friend, My favorite food is chicken leg, my nickname is: Linh 2k6. 
                        </p>
                        </animated.div>
